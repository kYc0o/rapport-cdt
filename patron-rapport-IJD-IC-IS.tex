...
Donner un peu d'historique => début du projet en 2013, etc

Parler ici des partenaires: Inria, Université Libre de Berlin et Université de
Hambourg
...
Donner une estimation des contributeurs
...
power and Lossy Networks),
    \item Les réseaux ICN (Information Centric Networking)\cite{ICN_RIOT} dont le but est de
traiter la localisation et la reproduction de contenu dans la réseau, sans
adressage IP,
...
contraints\cite{model-at-runtime}, en utilisant les protocoles réseaux sans fil de l'IoT (Internet
...
développeurs.
Plus précisément, ces objectifs sont les suivant:
\begin{description}
    ...
    \item[Mise à jour des composants logiciels de RIOT :] La mise à jour d'un système
        ...
        cas, d'un système embarqué IoT fortement contraint, ces mises à jour représente
        encore un défi technique très complexe: les réseaux sans-fil sont peu fiables,
        les équipements n'ont pas d'interface utilisateur accessible à distance et
        l'espace mémoire y est très limitée. (autres problèmes?)
    ...
    \item[Revue de Code :] La revue de code consiste à vérifier que le code écrit par les
        ...
        projet. Les vérifications fonctionnelles s'effectue soit à distance dans un
